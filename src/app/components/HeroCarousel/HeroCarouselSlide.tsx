...
const HeroCarouselSlide: FC<HeroCarouselSlideProps> = (props) => {
  ...
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-end overflow-clip rounded-2xl p-12 max-lg:min-h-[300px] max-lg:p-6 lg:min-h-[635px]">
      {img && (
        <>
