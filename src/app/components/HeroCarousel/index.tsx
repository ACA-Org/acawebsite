...
const HeroCarousel: React.FC<HeroCarouselProps> = ({ slides }) => {
  return (
    <div className="w-full">
      <div className="mx-auto w-full max-w-[1200px] overflow-clip px-4 pb-8 md:overflow-visible md:px-8">
        <Swiper
        ...
        >
          ...
          <SlideControls className="z-40 mt-3 !left-1/2 !right-auto !bottom-auto !-translate-x-1/2 [&_button]:!border-[#FFC72C] [&_button]:!bg-[#0F2D52] [&_button]:!text-[#FFC72C] [&_svg]:!text-[#FFC72C]" />
        </Swiper>
      </div>
    </div>
  );
