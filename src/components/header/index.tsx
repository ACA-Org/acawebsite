...
const Header = ({
    ...
    return (
        <header
            className={cn(
                "fixed top-0 left-0 right-0 px-9 flex items-center justify-between w-full bg-[#f9f9f9] transition-all duration-300 ease-in-out z-50 border-b-[rgba(0,95,150,0.08)] border-b border-solid",
