...
const SocialCarousel: FC<SocialCarouselProps> = ({ slice }) => {
  ...
  return (
    <div className="relative flex w-full flex-col items-start gap-16 rounded-2xl border border-solid border-[#0f2d5226] bg-blue-50 px-8 pt-12 pb-8">
      <div className="w-full p-0">
        <div className="flex w-full items-start justify-between">
          <div className="flex flex-1 grow flex-col items-start gap-6">
            {title && (
              <h2 className="heading-2 mt-[-1.00px] self-stretch text-blue-300">
                {title}
              </h2>
            )}
